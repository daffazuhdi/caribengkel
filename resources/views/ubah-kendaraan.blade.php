...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active  px-0 py-4" id="vehicle" role="tabpanel" aria-labelledby="vehicle-tab" style="padding: 1%">
        <div class="row align-items-center justify-content-center p-2" style="border: none;">
            ...
            <table class="table w-25">
                <thead class="table">
                    <tr>
                        {{-- <th scope="col" style="background-color: #F3F9F9 !important; text-align: center; font-weight: 400; font-size: 16px;">No</th> --}}
                        <th scope="col" style="background-color: #F3F9F9 !important; text-align: center; font-weight: 400; font-size: 16px;">Riwayat servis</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($services as $s)
                        <tr>
                            {{-- <th scope="row" style="font-weight: 600; font-size: 16px;">{{ $no }}</th> --}}
                            <td>
            ...
            <div class="d-flex justify-start">
                <button class="btn btn-outline-danger px-3" data-bs-toggle="modal" data-bs-target="#deleteCar">Hapus</button>
                <!-- Modal -->
